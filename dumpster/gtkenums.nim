...
type
  GtkDeleteType* = enum
    ...
    GTK_DELETE_PARAGRAPH_ENDS, GTK_DELETE_PARAGRAPHS, GTK_DELETE_WHITESPACE
...
type
  GtkDirectionType* = enum
    GTK_DIR_TAB_FORWARD, GTK_DIR_TAB_BACKWARD, GTK_DIR_UP, GTK_DIR_DOWN,
...
type
  GtkMovementStep* = enum
    ...
    GTK_MOVEMENT_PARAGRAPH_ENDS, GTK_MOVEMENT_PAGES, GTK_MOVEMENT_BUFFER_ENDS,
...
type
  GtkScrollType* = enum
    ...
    GTK_SCROLL_STEP_FORWARD, GTK_SCROLL_PAGE_BACKWARD, GTK_SCROLL_PAGE_FORWARD,
    GTK_SCROLL_STEP_UP, GTK_SCROLL_STEP_DOWN, GTK_SCROLL_PAGE_UP,
    GTK_SCROLL_PAGE_DOWN, GTK_SCROLL_STEP_LEFT, GTK_SCROLL_STEP_RIGHT,
    GTK_SCROLL_PAGE_LEFT, GTK_SCROLL_PAGE_RIGHT, GTK_SCROLL_START, GTK_SCROLL_END
...
##  identify different colors in a
##  used for subparts of a widget as well as entire widgets.
##
##  Deprecated: 3.14: All APIs that are using this enumeration have been deprecated
##      in favor of alternatives using
##

type
  GtkStateType* = enum
    GTK_STATE_NORMAL, GTK_STATE_ACTIVE, GTK_STATE_PRELIGHT, GTK_STATE_SELECTED,
    GTK_STATE_INSENSITIVE, GTK_STATE_INCONSISTENT, GTK_STATE_FOCUSED
...
type
  GtkPackDirection* = enum
    GTK_PACK_DIRECTION_LTR, GTK_PACK_DIRECTION_RTL, GTK_PACK_DIRECTION_TTB,
...
type
  GtkPageOrientation* = enum
    ...
    GTK_PAGE_ORIENTATION_REVERSE_PORTRAIT, GTK_PAGE_ORIENTATION_REVERSE_LANDSCAPE
...
type
  GtkPrintQuality* = enum
    GTK_PRINT_QUALITY_LOW, GTK_PRINT_QUALITY_NORMAL, GTK_PRINT_QUALITY_HIGH,
...
type
  GtkPrintDuplex* = enum
    GTK_PRINT_DUPLEX_SIMPLEX, GTK_PRINT_DUPLEX_HORIZONTAL,
...
type
  GtkTreeViewGridLines* = enum
    GTK_TREE_VIEW_GRID_LINES_NONE, GTK_TREE_VIEW_GRID_LINES_HORIZONTAL,
...
type
  GtkSizeRequestMode* = enum
    GTK_SIZE_REQUEST_HEIGHT_FOR_WIDTH = 0, GTK_SIZE_REQUEST_WIDTH_FOR_HEIGHT,
...
type
  GtkScrollablePolicy* = enum
    GTK_SCROLL_MINIMUM = 0, GTK_SCROLL_NATURAL
...
type
  GtkStateFlags* = enum
    GTK_STATE_FLAG_NORMAL = 0, GTK_STATE_FLAG_ACTIVE = 1 shl 0,
...
type
  GtkRegionFlags* = enum
    GTK_REGION_EVEN = 1 shl 0, GTK_REGION_ODD = 1 shl 1, GTK_REGION_FIRST = 1 shl 2,
    GTK_REGION_LAST = 1 shl 3, GTK_REGION_ONLY = 1 shl 4, GTK_REGION_SORTED = 1 shl 5
...
type
  GtkJunctionSides* = enum
    GTK_JUNCTION_NONE = 0, GTK_JUNCTION_CORNER_TOPLEFT = 1 shl 0,
    GTK_JUNCTION_CORNER_TOPRIGHT = 1 shl 1, GTK_JUNCTION_CORNER_BOTTOMLEFT = 1 shl 2,
    GTK_JUNCTION_CORNER_BOTTOMRIGHT = 1 shl 3, GTK_JUNCTION_TOP = (
...
type
  GtkBorderStyle* = enum
    GTK_BORDER_STYLE_NONE, GTK_BORDER_STYLE_SOLID, GTK_BORDER_STYLE_INSET,
...
type
  GtkInputPurpose* = enum
    GTK_INPUT_PURPOSE_FREE_FORM, GTK_INPUT_PURPOSE_ALPHA,
    GTK_INPUT_PURPOSE_DIGITS, GTK_INPUT_PURPOSE_NUMBER, GTK_INPUT_PURPOSE_PHONE,
    GTK_INPUT_PURPOSE_URL, GTK_INPUT_PURPOSE_EMAIL, GTK_INPUT_PURPOSE_NAME,
    GTK_INPUT_PURPOSE_PASSWORD, GTK_INPUT_PURPOSE_PIN, GTK_INPUT_PURPOSE_TERMINAL
...
type
  GtkInputHints* = enum
    GTK_INPUT_HINT_NONE = 0, GTK_INPUT_HINT_SPELLCHECK = 1 shl 0,
...
type
  GtkPanDirection* = enum
    GTK_PAN_DIRECTION_LEFT, GTK_PAN_DIRECTION_RIGHT, GTK_PAN_DIRECTION_UP,
...
type
  GtkPopoverConstraint* = enum
    GTK_POPOVER_CONSTRAINT_NONE, GTK_POPOVER_CONSTRAINT_WINDOW
