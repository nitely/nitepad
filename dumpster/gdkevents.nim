...
type
  GdkEventAny* = _GdkEventAny
  GdkEventExpose* = _GdkEventExpose
  GdkEventVisibility* = _GdkEventVisibility
  GdkEventMotion* = _GdkEventMotion
  GdkEventButton* = _GdkEventButton
  GdkEventTouch* = _GdkEventTouch
  GdkEventScroll* = _GdkEventScroll
  GdkEventKey* = _GdkEventKey
  GdkEventFocus* = _GdkEventFocus
  GdkEventCrossing* = _GdkEventCrossing
  GdkEventConfigure* = _GdkEventConfigure
  GdkEventProperty* = _GdkEventProperty
  GdkEventSelection* = _GdkEventSelection
  GdkEventOwnerChange* = _GdkEventOwnerChange
  GdkEventProximity* = _GdkEventProximity
  GdkEventDND* = _GdkEventDND
  GdkEventWindowState* = _GdkEventWindowState
  GdkEventSetting* = _GdkEventSetting
  GdkEventGrabBroken* = _GdkEventGrabBroken
  GdkEventTouchpadSwipe* = _GdkEventTouchpadSwipe
  GdkEventTouchpadPinch* = _GdkEventTouchpadPinch
  GdkEventPadButton* = _GdkEventPadButton
  GdkEventPadAxis* = _GdkEventPadAxis
  GdkEventPadGroupMode* = _GdkEventPadGroupMode
  GdkEventSequence* = _GdkEventSequence
  GdkEvent* = _GdkEvent
...
type
  GdkEventFunc* = proc (event: ptr GdkEvent; data: gpointer)
...
type
  GdkFilterFunc* = proc (xevent: ptr GdkXEvent; event: ptr GdkEvent; data: gpointer): GdkFilterReturn
...
##  @GDK_WINDOW_STATE: the state of a window has changed. See
...
type
  GdkTouchpadGesturePhase* = enum
    GDK_TOUCHPAD_GESTURE_PHASE_BEGIN, GDK_TOUCHPAD_GESTURE_PHASE_UPDATE,
...
type
  GdkNotifyType* = enum
    GDK_NOTIFY_ANCESTOR = 0, GDK_NOTIFY_VIRTUAL = 1, GDK_NOTIFY_INFERIOR = 2,
    GDK_NOTIFY_NONLINEAR = 3, GDK_NOTIFY_NONLINEAR_VIRTUAL = 4, GDK_NOTIFY_UNKNOWN = 5
...
type
  GdkWindowState* = enum
    GDK_WINDOW_STATE_WITHDRAWN = 1 shl 0, GDK_WINDOW_STATE_ICONIFIED = 1 shl 1,
    GDK_WINDOW_STATE_MAXIMIZED = 1 shl 2, GDK_WINDOW_STATE_STICKY = 1 shl 3,
    GDK_WINDOW_STATE_FULLSCREEN = 1 shl 4, GDK_WINDOW_STATE_ABOVE = 1 shl 5,
    GDK_WINDOW_STATE_BELOW = 1 shl 6, GDK_WINDOW_STATE_FOCUSED = 1 shl 7,
    GDK_WINDOW_STATE_TILED = 1 shl 8, GDK_WINDOW_STATE_TOP_TILED = 1 shl 9,
    GDK_WINDOW_STATE_TOP_RESIZABLE = 1 shl 10,
    GDK_WINDOW_STATE_RIGHT_TILED = 1 shl 11,
    GDK_WINDOW_STATE_RIGHT_RESIZABLE = 1 shl 12,
    GDK_WINDOW_STATE_BOTTOM_TILED = 1 shl 13,
    GDK_WINDOW_STATE_BOTTOM_RESIZABLE = 1 shl 14,
    GDK_WINDOW_STATE_LEFT_TILED = 1 shl 15,
    GDK_WINDOW_STATE_LEFT_RESIZABLE = 1 shl 16
...
type
  _GdkEventVisibility* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
...
##    %GDK_POINTER_MOTION_HINT_MASK value of
...
type
  _GdkEventCrossing* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    subwindow*: ptr GdkWindow
    time*: guint32
    x*: gdouble
    y*: gdouble
    x_root*: gdouble
...
type
  _GdkEventConfigure* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    x*: gint
...
type
  _GdkEventProperty* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    atom*: GdkAtom
...
type
  _GdkEventSelection* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    selection*: GdkAtom
...
##  @reason: the reason for the ownership change as a
...
type
  _GdkEventOwnerChange* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    owner*: ptr GdkWindow
...
type
  _GdkEventProximity* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    time*: guint32
...
type
  _GdkEventSetting* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
...
type
  _GdkEventWindowState* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
...
type
  _GdkEventGrabBroken* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    keyboard*: gboolean
...
type
  _GdkEventTouchpadSwipe* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    phase*: gint8
...
type
  _GdkEventTouchpadPinch* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    phase*: gint8
...
type
  _GdkEventPadButton* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    time*: guint32
...
type
  _GdkEventPadAxis* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    time*: guint32
...
type
  _GdkEventPadGroupMode* {.bycopy.} = object
    `type`*: GdkEventType
    window*: ptr GdkWindow
    send_event*: gint8
    time*: guint32
