...
type
  _GdkRectangle* {.bycopy.} = object
    x*: cint
    y*: cint
    width*: cint
    height*: cint

  GdkRectangle* = _GdkRectangle
...
type
  GdkColor* = _GdkColor
  GdkRGBA* = _GdkRGBA
  GdkCursor* = _GdkCursor
  GdkVisual* = _GdkVisual
  GdkDevice* = _GdkDevice
  GdkDragContext* = _GdkDragContext
  GdkDisplayManager* = _GdkDisplayManager
  GdkDeviceManager* = _GdkDeviceManager
  GdkDisplay* = _GdkDisplay
  GdkScreen* = _GdkScreen
  GdkWindow* = _GdkWindow
  GdkKeymap* = _GdkKeymap
  GdkAppLaunchContext* = _GdkAppLaunchContext
  GdkSeat* = _GdkSeat
  GdkGLContext* = _GdkGLContext
...
type
  GdkModifierType* = enum
    GDK_SHIFT_MASK = 1 shl 0, GDK_LOCK_MASK = 1 shl 1, GDK_CONTROL_MASK = 1 shl 2,
    GDK_MOD1_MASK = 1 shl 3, GDK_MOD2_MASK = 1 shl 4, GDK_MOD3_MASK = 1 shl 5,
    GDK_MOD4_MASK = 1 shl 6, GDK_MOD5_MASK = 1 shl 7, GDK_BUTTON1_MASK = 1 shl 8,
    GDK_BUTTON2_MASK = 1 shl 9, GDK_BUTTON3_MASK = 1 shl 10, GDK_BUTTON4_MASK = 1 shl 11,
    GDK_BUTTON5_MASK = 1 shl 12, GDK_MODIFIER_RESERVED_13_MASK = 1 shl 13,
    ...
    GDK_MODIFIER_RESERVED_24_MASK = 1 shl 24, GDK_MODIFIER_RESERVED_25_MASK = 1 shl
        25, ##  The next few modifiers are used by XKB, so we skip to the end.
           ##  Bits 15 - 25 are currently unused. Bit 29 is used internally.
           ##
    GDK_SUPER_MASK = 1 shl 26, GDK_HYPER_MASK = 1 shl 27, GDK_META_MASK = 1 shl 28,
    GDK_MODIFIER_RESERVED_29_MASK = 1 shl 29, GDK_RELEASE_MASK = 1 shl 30, ##  Combination of GDK_SHIFT_MASK..GDK_BUTTON5_MASK + GDK_SUPER_MASK
...
type
  ...
  GdkStatus* = enum
    GDK_ERROR_MEM = -4, GDK_ERROR_FILE = -3, GDK_ERROR_PARAM = -2, GDK_ERROR = -1,
    GDK_OK = 0
...
type
  GdkGrabStatus* = enum
    GDK_GRAB_SUCCESS = 0, GDK_GRAB_ALREADY_GRABBED = 1, GDK_GRAB_INVALID_TIME = 2,
    GDK_GRAB_NOT_VIEWABLE = 3, GDK_GRAB_FROZEN = 4, GDK_GRAB_FAILED = 5
...
type
  GdkGrabOwnership* = enum
    GDK_OWNERSHIP_NONE, GDK_OWNERSHIP_WINDOW, GDK_OWNERSHIP_APPLICATION
...
##  from touch-enabled devices. Those will come as sequences of
...
type
  GdkEventMask* = enum
    GDK_EXPOSURE_MASK = 1 shl 1, GDK_POINTER_MOTION_MASK = 1 shl 2,
    GDK_POINTER_MOTION_HINT_MASK = 1 shl 3, GDK_BUTTON_MOTION_MASK = 1 shl 4,
    GDK_BUTTON1_MOTION_MASK = 1 shl 5, GDK_BUTTON2_MOTION_MASK = 1 shl 6,
    GDK_BUTTON3_MOTION_MASK = 1 shl 7, GDK_BUTTON_PRESS_MASK = 1 shl 8,
    GDK_BUTTON_RELEASE_MASK = 1 shl 9, GDK_KEY_PRESS_MASK = 1 shl 10,
    GDK_KEY_RELEASE_MASK = 1 shl 11, GDK_ENTER_NOTIFY_MASK = 1 shl 12,
    GDK_LEAVE_NOTIFY_MASK = 1 shl 13, GDK_FOCUS_CHANGE_MASK = 1 shl 14,
    GDK_STRUCTURE_MASK = 1 shl 15, GDK_PROPERTY_CHANGE_MASK = 1 shl 16,
    GDK_VISIBILITY_NOTIFY_MASK = 1 shl 17, GDK_PROXIMITY_IN_MASK = 1 shl 18,
    GDK_PROXIMITY_OUT_MASK = 1 shl 19, GDK_SUBSTRUCTURE_MASK = 1 shl 20,
    GDK_SCROLL_MASK = 1 shl 21, GDK_TOUCH_MASK = 1 shl 22,
    GDK_SMOOTH_SCROLL_MASK = 1 shl 23, GDK_TOUCHPAD_GESTURE_MASK = 1 shl 24,
    GDK_TABLET_PAD_MASK = 1 shl 25, GDK_ALL_EVENTS_MASK = 0x03FFFFFE
...
type
  GdkGLError* = enum
    GDK_GL_ERROR_NOT_AVAILABLE, GDK_GL_ERROR_UNSUPPORTED_FORMAT,
...
type
  GdkWindowTypeHint* = enum
    GDK_WINDOW_TYPE_HINT_NORMAL, GDK_WINDOW_TYPE_HINT_DIALOG, GDK_WINDOW_TYPE_HINT_MENU, ##  Torn off menu
    GDK_WINDOW_TYPE_HINT_TOOLBAR, GDK_WINDOW_TYPE_HINT_SPLASHSCREEN,
    GDK_WINDOW_TYPE_HINT_UTILITY, GDK_WINDOW_TYPE_HINT_DOCK,
    GDK_WINDOW_TYPE_HINT_DESKTOP, GDK_WINDOW_TYPE_HINT_DROPDOWN_MENU, ##  A drop down menu (from a menubar)
...
type
  GdkAxisUse* = enum
    GDK_AXIS_IGNORE, GDK_AXIS_X, GDK_AXIS_Y, GDK_AXIS_PRESSURE, GDK_AXIS_XTILT,
...
type
  GdkAxisFlags* = enum
    GDK_AXIS_FLAG_X = 1 shl GDK_AXIS_X, GDK_AXIS_FLAG_Y = 1 shl GDK_AXIS_Y,
